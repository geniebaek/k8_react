...
export default function MyRef() {
  ...
  return (
    ...
    <div className="w3/5 grid grid-cols-5 p-2 gap-2 bg-slate-200">
    <div className="flex justify-center items-center text-center">
      <input ref={x} type='number' id='txt1' name="txt1" className="text-center h-10 w-24"
                 onFocus={handleFocus}/>
    </div>
    ...
    <div className="flex justify-center items-center text-center">
      <input ref={y} type='number' id='txt2' name="txt2" className="text-center h-10 w-24"
                onFocus={handleFocus}/>
    </div>
    <div className="flex justify-center items-center text-center">
    <TailButton caption='='
    ...
    <div className="flex justify-center items-center text-center">
      <input ref={z} type='number' id='txt3' name="txt3" readOnly className="text-center h-10 w-24"
                   onFocus={handleFocus}/>
    </div>
